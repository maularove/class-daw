...
INSERT INTO
    categories (name_es, name_en, slug)
VALUES (
        'Novedades',
        'New Releases',
        'new-releases'
...
VALUES (
        ...
        15.99,
        10.00,
        'http://images.cesguiro.es/books/9780142424179.webp',
        1,
        1
    ),
    (
        ...
        14.99,
        5.00,
        'http://images.cesguiro.es/books/9780142410363.webp',
        2,
        2
    ),
    (
        ...
        13.99,
        15.00,
        'http://images.cesguiro.es/books/9780142418222.jpeg',
        2,
        4
    ),
    (
        ...
        16.99,
        15.00,
        'http://images.cesguiro.es/books/9780060256654.webp',
        3,
        4
    ),
    (
        ...
        18.99,
        0.00,
        'http://images.cesguiro.es/books/9780618260300.webp',
        3,
        3
    ),
    (
        ...
        19.99,
        15.00,
        'http://images.cesguiro.es/books/9780439554930.webp',
        4,
        4
    ),
    (
        ...
        12.99,
        5.00,
        'http://images.cesguiro.es/books/9781451673319.jpg',
        5,
        1
    ),
    (
        ...
        11.99,
        0.00,
        'http://images.cesguiro.es/books/9780064400558.webp',
        5,
        2
    ),
    (
        ...
        19.99,
        0.00,
        'http://images.cesguiro.es/books/9780439023528.webp',
        3,
        3
    ),
    (
        ...
        17.99,
        0.00,
        'http://images.cesguiro.es/books/9781423103349.webp',
        4,
        1
    );
...
VALUES (
        ...
        15.99,
        0.00,
        'http://images.cesguiro.es/books/9780316015844.webp',
        2,
        2
    ),
    (
        ...
        18.99,
        10.00,
        'http://images.cesguiro.es/books/9780062024039.webp',
        5,
        3
    ),
    (
        ...
        17.99,
        15.00,
        'http://images.cesguiro.es/books/9781416914280.webp',
        1,
        4
    ),
    (
        ...
        16.99,
        15.00,
        'http://images.cesguiro.es/books/9780385737951.webp',
        3,
        4
    ),
    (
        ...
        14.99,
        5.00,
        'http://images.cesguiro.es/books/9781250047819.webp',
        4,
        1
    ),
    (
        ...
        15.99,
        15.00,
        'http://images.cesguiro.es/books/9780142424180.webp',
        2,
        4
    ),
    (
        ...
        14.99,
        0.00,
        'http://images.cesguiro.es/books/9780618260400.jpg',
        3,
        2
    ),
    (
        ...
        19.99,
        0.00,
        'http://images.cesguiro.es/books/9780261103573.webp',
        3,
        3
    ),
    (
        ...
        19.99,
        0.00,
        'http://images.cesguiro.es/books/9780261102361.webp',
        3,
        1
    ),
    (
        ...
        18.99,
        10.00,
        'http://images.cesguiro.es/books/9780316029186.jpg',
        4,
        2
    );
...
VALUES (
    ...
    (
        ...
        16.99,
        0.00,
        'http://images.cesguiro.es/books/9780060557912.jpg',
        5,
        2
    ),
    (
        ...
        17.99,
        15.00,
        'http://images.cesguiro.es/books/9780060853983.webp',
        5,
        4
    ),
    (
        ...
        15.99,
        5.00,
        'http://images.cesguiro.es/books/9780060557812.webp',
        5,
        2
    );
...
VALUES (
    ...
    (
        'J.K. Rowling',
        'British',
        'J.K. Rowling es una autora británica, conocida por la serie Harry Potter.',
    ...
    (
        'Munro Leaf',
        'American',
        'Munro Leaf fue un autor estadounidense de literatura infantil que escribió El cuento de Ferdinando.',
    ...
    (
        'Suzanne Collins',
        'American',
        'Suzanne Collins es una guionista y autora estadounidense, conocida por la serie Los Juegos del Hambre.',
    ...
    (
        'Terry Pratchett',
        'British',
        'Terry Pratchett fue un autor inglés de novelas de fantasía, conocido por su serie Mundodisco.',
    ...
    (
        'Andrzej Sapkowski',
        'Polish',
        'Andrzej Sapkowski es un escritor de fantasía polaco, conocido por su serie de libros The Witcher.',
...
VALUES (1, 1), -- El principito (Infantil)
...
VALUES (
        1,
        7,
        'Review for book 1 by user 7',
        1
    ),
    (
        1,
        5,
        'Review for book 1 by user 5',
        5
    ),
    (
        1,
        1,
        'Review for book 1 by user 1',
        4
    ),
    (
        1,
    ...
    (
        1,
        8,
        'Review for book 1 by user 8',
        4
    ),
    (
        2,
        1,
        'Review for book 2 by user 1',
        2
    ),
    (
        2,
        4,
        'Review for book 2 by user 4',
        5
    ),
    (
        2,
        3,
        'Review for book 2 by user 3',
        4
    ),
    (
        2,
        10,
        'Review for book 2 by user 10',
        2
    ),
    (
        2,
...
VALUES (
        3,
        8,
        'Review for book 3 by user 8',
        5
    ),
    (
        3,
        7,
        'Review for book 3 by user 7',
        3
    ),
    (
        3,
        1,
        'Review for book 3 by user 1',
        2
    ),
    (
        3,
    ...
    (
        3,
        3,
        'Review for book 3 by user 3',
        1
    ),
    (
        3,
        6,
        'Review for book 3 by user 6',
        2
    ),
    (
        4,
        7,
        'Review for book 4 by user 7',
        5
    ),
    (
        4,
        2,
        'Review for book 4 by user 2',
        2
    );
...
VALUES (
    ...
    (
        5,
        6,
        'Review for book 5 by user 6',
        2
    ),
    (
        5,
        2,
        'Review for book 5 by user 2',
        3
    ),
    (
        5,
        5,
        'Review for book 5 by user 5',
        4
    ),
    (
        5,
        1,
        'Review for book 5 by user 1',
        1
    ),
    (
        5,
        8,
        'Review for book 5 by user 8',
        1
    ),
    (
        5,
...
VALUES (
        6,
        8,
        'Review for book 6 by user 8',
        4
    ),
    (
        6,
        10,
        'Review for book 6 by user 10',
        5
    ),
    (
        6,
        3,
        'Review for book 6 by user 3',
        5
    ),
    (
        6,
    ...
    (
        7,
        4,
        'Review for book 7 by user 4',
        4
    ),
    (
        7,
        6,
        'Review for book 7 by user 6',
        2
    ),
    (
        7,
        2,
        'Review for book 7 by user 2',
        4
    ),
    (
        7,
    ...
    (
        7,
        9,
        'Review for book 7 by user 9',
        1
    ),
    (
        8,
        2,
        'Review for book 8 by user 2',
        3
    );
...
VALUES (
        8,
        4,
        'Review for book 8 by user 4',
        5
    ),
    (
        8,
        6,
        'Review for book 8 by user 6',
        1
    ),
    (
        8,
    ...
    (
        8,
        5,
        'Review for book 8 by user 5',
        3
    ),
    (
        9,
        7,
        'Review for book 9 by user 7',
        4
    ),
    (
        9,
        9,
        'Review for book 9 by user 9',
        5
    ),
    (
        9,
        8,
        'Review for book 9 by user 8',
        2
    ),
    (
        9,
        3,
        'Review for book 9 by user 3',
        2
    ),
    (
        9,
...
VALUES (
        9,
        5,
        'Review for book 9 by user 5',
        4
    ),
    (
        10,
        7,
        'Review for book 10 by user 7',
        2
    ),
    (
        10,
        2,
        'Review for book 10 by user 2',
        5
    ),
    (
        10,
        4,
        'Review for book 10 by user 4',
        5
    ),
    (
        10,
    ...
    (
        10,
        8,
        'Review for book 10 by user 8',
        4
    ),
    (
        10,
        6,
        'Review for book 10 by user 6',
        2
    ),
    (
        10,
        10,
        'Review for book 10 by user 10',
        4
    ),
    (
        11,
        10,
        'Review for book 11 by user 10',
        1
    ),
    (
        11,
        8,
        'Review for book 11 by user 8',
        1
    );
...
VALUES (
    ...
    (
        12,
        9,
        'Review for book 12 by user 9',
        2
    ),
    (
        12,
        5,
        'Review for book 12 by user 5',
        4
    ),
    (
        12,
        1,
        'Review for book 12 by user 1',
        2
    ),
    (
        12,
...
VALUES (
        12,
        3,
        'Review for book 12 by user 3',
        1
    ),
    (
        13,
        9,
        'Review for book 13 by user 9',
        4
    ),
    (
        13,
        6,
        'Review for book 13 by user 6',
        1
    ),
    (
        13,
        7,
        'Review for book 13 by user 7',
        5
    ),
    (
        13,
        3,
        'Review for book 13 by user 3',
        4
    ),
    (
        13,
        5,
        'Review for book 13 by user 5',
        2
    ),
    (
        13,
        2,
        'Review for book 13 by user 2',
        4
    ),
    (
        13,
        4,
        'Review for book 13 by user 4',
        3
    ),
    (
        13,
...
VALUES (
    ...
    (
        14,
        3,
        'Review for book 14 by user 3',
        4
    ),
    (
        14,
        5,
        'Review for book 14 by user 5',
        3
    ),
    (
        14,
        7,
        'Review for book 14 by user 7',
        5
    ),
    (
        14,
    ...
    (
        14,
        1,
        'Review for book 14 by user 1',
        3
    ),
    (
        15,
        5,
        'Review for book 15 by user 5',
        1
    ),
    (
        15,
        1,
        'Review for book 15 by user 1',
        5
    ),
    (
        15,
        2,
        'Review for book 15 by user 2',
        2
    );
...
VALUES (
        15,
        8,
        'Review for book 15 by user 8',
        5
    ),
    (
        15,
        3,
        'Review for book 15 by user 3',
        4
    ),
    (
        15,
    ...
    (
        16,
        1,
        'Review for book 16 by user 1',
        5
    ),
    (
        16,
        2,
        'Review for book 16 by user 2',
        1
    ),
    (
        16,
        8,
        'Review for book 16 by user 8',
        4
    ),
    (
        16,
        6,
        'Review for book 16 by user 6',
        2
    ),
    (
        16,
        9,
        'Review for book 16 by user 9',
        2
    ),
    (
        16,
...
VALUES (
        17,
        10,
        'Review for book 17 by user 10',
        2
    ),
    (
        17,
        3,
        'Review for book 17 by user 3',
        4
    ),
    (
        17,
        9,
        'Review for book 17 by user 9',
        1
    ),
    (
        17,
        7,
        'Review for book 17 by user 7',
        2
    ),
    (
        17,
    ...
    (
        17,
        5,
        'Review for book 17 by user 5',
        1
    ),
    (
        17,
        1,
        'Review for book 17 by user 1',
        2
    ),
    (
        17,
        2,
        'Review for book 17 by user 2',
        5
    ),
    (
        18,
        3,
        'Review for book 18 by user 3',
        4
    ),
    (
        18,
...
VALUES (
        18,
        1,
        'Review for book 18 by user 1',
        3
    ),
    (
        18,
        10,
        'Review for book 18 by user 10',
        3
    ),
    (
        18,
        7,
        'Review for book 18 by user 7',
        4
    ),
    (
        18,
        8,
        'Review for book 18 by user 8',
        2
    ),
    (
        19,
        8,
        'Review for book 19 by user 8',
        2
    ),
    (
        19,
        2,
        'Review for book 19 by user 2',
        5
    ),
    (
        19,
        7,
        'Review for book 19 by user 7',
        5
    ),
    (
        19,
        3,
        'Review for book 19 by user 3',
        3
    ),
    (
        19,
        1,
        'Review for book 19 by user 1',
        4
    ),
    (
        19,
        4,
        'Review for book 19 by user 4',
        3
    );
...
VALUES (
    ...
    (
        20,
        7,
        'Review for book 20 by user 7',
        3
    ),
    (
        20,
        8,
        'Review for book 20 by user 8',
        5
    ),
    (
        20,
        5,
        'Review for book 20 by user 5',
        3
    ),
    (
        20,
    ...
    (
        20,
        1,
        'Review for book 20 by user 1',
        1
    ),
    (
        20,
        2,
        'Review for book 20 by user 2',
        3
    ),
    (
        20,
...
VALUES (
        21,
        7,
        'Review for book 21 by user 7',
        1
    ),
    (
        21,
        9,
        'Review for book 21 by user 9',
        5
    ),
    (
        21,
        10,
        'Review for book 21 by user 10',
        5
    ),
    (
        21,
        5,
        'Review for book 21 by user 5',
        4
    ),
    (
        21,
    ...
    (
        21,
        2,
        'Review for book 21 by user 2',
        1
    ),
    (
        22,
        3,
        'Review for book 22 by user 3',
        4
    ),
    (
        22,
        1,
        'Review for book 22 by user 1',
        2
    ),
    (
        22,
        8,
        'Review for book 22 by user 8',
        1
    );
...
VALUES (
        22,
        6,
        'Review for book 22 by user 6',
        1
    ),
    (
        22,
        9,
        'Review for book 22 by user 9',
        1
    ),
    (
        23,
        9,
        'Review for book 23 by user 9',
        2
    ),
    (
        23,
        3,
        'Review for book 23 by user 3',
        2
    ),
    (
        23,
        6,
        'Review for book 23 by user 6',
        5
    ),
    (
        23,
        1,
        'Review for book 23 by user 1',
        3
    ),
    (
        23,
        5,
        'Review for book 23 by user 5',
        5
    ),
    (
        23,
        8,
        'Review for book 23 by user 8',
        1
    ),
    (
        24,
        5,
        'Review for book 24 by user 5',
        5
    ),
    (
        24,
        4,
        'Review for book 24 by user 4',
        4
    );
...
VALUES (
        24,
        8,
        'Review for book 24 by user 8',
        3
    ),
    (
        24,
        6,
        'Review for book 24 by user 6',
        5
    ),
    (
        24,
        2,
        'Review for book 24 by user 2',
        5
    );